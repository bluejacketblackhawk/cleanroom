...
9. **Monetization (decided 2026-08-01):** free/MIT stands, never full commercial. Tips via Ko-fi (`ko-fi.com/bluejacketblackhawk`) in the README and FUNDING.yml only — **no monetization surface inside the app** (owner call, same day: an in-app tip button was added and removed). Store mirror: **Gumroad** pay-what-you-want listing of the identical installers, owner-run, linked from the README once it exists; GitHub downloads stay free and first-class.
